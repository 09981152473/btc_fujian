			...
			<table class="">
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td><?php echo ($vo["alipay"]); ?></td>
                                                        ...
                                                        <!--
                                                        <td>
								<a href="<?php echo U('User/index?name='.$vo['invit_0'].'&field=id');?>"><?php echo ($vo['invit_0']); ?></a>
							</td>
							<td>
							...
							<td>
								<a href="<?php echo U('User/index?name='.$vo['invit_3'].'&field=id');?>"><?php echo ($vo['invit_3']); ?></a>
                                                        ...
                                                        <td><?php echo ($vo['invit_0']); ?></td>
							<td><?php echo ($vo['invit_1']); ?></td>
							<td><?php echo ($vo['invit_2']); ?></td>
							<td><?php echo ($vo['invit_3']); ?></td>
                                                        
							<td><?php echo (addtime($vo["addtime"])); ?></td>
                                                        
                                                        <td><?php echo ($vo["left_yeji"]); ?></td>
                                                        <td><?php echo ($vo["right_yeji"]); ?></td>
