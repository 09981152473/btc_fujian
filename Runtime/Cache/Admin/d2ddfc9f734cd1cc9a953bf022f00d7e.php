...
<div id="main-content">
	...
	<div id="main" class="main">
		<div class="main-title-h" >
			<span class="h1-title" style="float:left;">认购管理</span>
                        
                        <!--设置认购总量-->
                        <!--
                        <div style="float:left;margin-left:5px;height:20px;line-height:20px;margin-top:10px;">
                            <form action="/Admin/Issue/save_issue_total" method="POST" >
                                <label for='issuetotal'>最大发行量：</label><input type="text" id="issuetotal" name="issuetotal" value="<?php echo ($issue_num); ?>" style="width:80px;" />
                                <input type="submit" value="提交"  style="width:40px;background-color:#005916;"/>
                                <span style="height:20px;line-height:20px;font-size:16px;margin-top:13px;">已发行<i style="color:red;"> <?php echo ($issued_num); ?> </i>枚</span>
                            </form>
                        </div>
                        -->
                        ...
                        <!--
                        <div style='float:left;margin-left:5px;height:20px;line-height:20px;margin-top:10px;'>
                            <form action ='/Admin/Issue/save_nextrate' method="POST">
                                <label for='nextrate'>下级提成比例：</label><input type="text" id="nextrate" name="nextrate" value="<?php echo ($nextrate); ?>" style="width:20px;"/>
                                <span style="color:red;height:15px;line-height:15px;font-size:15px;">%</span>
                                <input type="submit" value="提交"  style="width:40px;background-color:#005916;"/>
                            </form>
                        </div>
                        -->
                        ...
                        <!--
                        <div style='float:left;margin-left:5px;height:20px;line-height:20px;margin-top:10px;'>
                            <form action ='/Admin/Issue/save_chabilv' method="POST">
                                <label for='nextrate'>产币率：</label><input type="text" id="chanbilv" name="chanbilv" value="<?php echo ($chabilv); ?>" style="width:30px;"/>
                                <span style="color:red;height:15px;line-height:15px;font-size:15px;">%</span>
                                <input type="submit" value="提交"  style="width:40px;background-color:#005916;"/>
                            </form>
                        </div>
                        ...
                        <!--
                        <div style='float:left;margin-left:5px;height:20px;line-height:20px;margin-top:10px;'>
                            <form action ='/Admin/Issue/save_jtbl' method="POST">
                                <label for='jtbl'>静态倍率：</label><input type="text" id="jtbl" name="jtbl" value="<?php echo ($jtbl); ?>" style="width:30px;" />
                                <span style="color:red;height:15px;line-height:15px;font-size:15px;">4.50代表4.5倍</span>
                                <input type="submit" value="提交"  style="width:40px;background-color:#005916;"/>
                            </form>
                        </div>
                        -->
                        ...
                        <!--
                        <div style='float:left;margin-left:5px;height:20px;line-height:20px;margin-top:10px;'>
                            <form action ='/Admin/Issue/save_fenpei' method="POST">
                                <label>奖金分配--</label>
                                <label for='trade'>交易：</label><input type="text" id="trade" name="trade" value="<?php echo ($trade); ?>" style="width:30px;" />
                                <label for='market'>商城：</label><input type="text" id="market" name="market" value="<?php echo ($market); ?>" style="width:30px;" />
                                <label for='found'>基金：</label><input type="text" id="found" name="found" value="<?php echo ($found); ?>" style="width:30px;" />
                                <span style="color:red;height:15px;line-height:15px;font-size:15px;">三者之和加起来为100</span>
                                <input type="submit" value="提交"  style="width:40px;background-color:#005916;"/>
                            </form>
                        </div>
                        -->
