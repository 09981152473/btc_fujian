...
<div id="main-content">
	<div id="top-alert" class="fixed alert alert-error" style="display: none;">
		...
		<div class="alert-content">警告</div>
	</div>
	<div id="main" class="main">
		<div class="main-title-h">
			<span class="h1-title">安置人申请</span>
		</div>
			...
			<table class="">
				...
				<tr>
					...
					<th class="">指向谁</th>
                                        <th class="">市场</th>
					<th class="">注册时间</th>
					<th class="" style="padding-left:65px;">操作</th>
				</tr>
				</thead>
				<tbody>
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td><?php echo ($vo["requestUser"]); ?></td>
							<td><?php echo ($vo["invit_1"]); ?></td>
							<td><?php echo ($vo["area"]); ?></td>
							<td><?php echo (date("Y-m-d H:i:s",$vo["time"])); ?></td>
                                                        <td>
                                                            <?php if(($vo["status"]) == "0"): ?><!--
								<a href="<?php echo U('User/apply_pass?id='.$vo['id']);?>" class="ajax-get btn btn-primary btn-xs">确认通过</a>
                                                            -->
                                                                <a href="<?php echo U('User/apply_pass?id='.$vo['id']);?>" class="btn btn-primary btn-xs">确认通过</a><?php endif; ?>
                                                        </td>
...
//			});
	...
	<script type="text/javascript" charset="utf-8">
		...
		highlight_subnav("<?php echo U('User/index');?>");
                ...
                //添加“修改安置人申请管理”导航
                var nav_str = '<li><a class="item" href="/Admin/User/apply_show.html"><span class="glyphicon glyphicon-globe" aria-hidden="true"></span>  安置人申请</li>';
         $("#subnav>ul:eq(0)>li:eq(1)").before(nav_str);
