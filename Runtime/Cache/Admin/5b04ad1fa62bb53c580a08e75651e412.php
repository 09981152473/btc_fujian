							...
							<table>
								<tr class="controls">
									...
									<td>
										<input type="text" class=" form-control input-10x " name="name"
                                                                                    <?php if($data["name"] != ''): ?>value="<?php echo ($data["name"]); ?>" disabled="disabled"<?php endif; ?>
                                                                                       >
									</td>
								...
								<tr class="controls">
									...
									<td class="item-note"></td>
                                                                ...
                                                                <tr class="controls">
									<td class="item-label">提    成:</td>
									<td>
										<input type="text" class="form-control  input-10x " name="ticheng" value="<?php echo ($data["ticheng"]); ?>">
									</td>
									<td class="item-note">%</td>
								</tr>

								<tr class="controls">
									<td class="item-label">提成封顶:</td>
									<td>
										<input type="text" class="form-control  input-10x " name="tichengmax" value="<?php echo ($data["tichengmax"]); ?>">
									</td>
									<td class="item-note">单体提成封顶个数</td>
								</tr>

                                                                <!--
								<tr class="controls">
									<td class="item-label">下级提成率 :</td>
									<td>
										<input type="text" class="form-control  input-10x " name="nextrate" value="<?php echo ($data["nextrate"]); ?>">
									</td>
									<td class="item-note">%</td>
								</tr>
                                                                -->
